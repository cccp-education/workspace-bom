    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("N0 shared library — cross-borough internationalization contracts (SupportedLanguage, LanguageCatalog, I18nConfig, MessageBundle, LocaleResolver)")
