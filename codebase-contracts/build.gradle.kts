...
dependencies {
    // Zéro dépendance sauf kotlin-stdlib — contrats purs N0
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("Codebase Contracts")
                description.set("N0 shared library — cross-borough context contracts (ContextChannel, ChannelBudget, CompositeContext)")
                ...
                // RELOCATION — identique à agent-contracts
