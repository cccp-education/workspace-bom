...
val cucumberTest = tasks.register<Test>("cucumberTest") {
    description = "Runs Cucumber BDD tests (runtime-contracts)"
    group = "verification"
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("Runtime Contracts")
                description.set("N0 shared library — cross-borough formation runtime contracts (SessionBootstrap, ByokLlmConfig, SessionMemoryContract, LearnerProfile, InteractionProtocol, FormationTurn, FormationRuntimePort, MaterialUpdateContract)")
